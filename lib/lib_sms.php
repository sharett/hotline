...
*   Array of contacts to be loaded.
* @param string $day
*   String providing the day of the time range; one of: "Sun", "Mon", ... "Sat".
* @param string $startTime
*   Start time, as a string of the form HH:MM, where hours are between 0 and 23.
*   This provides the lower bound (inclusive) of the time range.
* @param string $endTime
*   End time, as a string of the form HH:MM, where hours are between 0 and 23.
*   This provides the upper bound (exclusive) of the time range.
* @param string $boundary
*   Either "earliest", meaning that transitions to on-shift are desired, or
*   "latest", meaning that transitions to off-shift are desired.
* @param string &$error
*   An error if one occurred.
*
* @return bool
